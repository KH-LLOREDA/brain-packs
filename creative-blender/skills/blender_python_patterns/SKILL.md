---
name: blender_python_patterns
description: >-
  Patrones bpy comunes: materiales, bmesh, cámara, render, errores frecuentes. CARGAR SIEMPRE.
metadata:
  category: media
  agent: blender_3d_creator
  display-name: "Patrones Blender Python"
---
