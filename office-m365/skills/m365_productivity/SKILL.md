---
name: m365_productivity
description: >-
  Referencia completa de todas las herramientas M365, patrones de uso y mejores prácticas. CARGAR SIEMPRE.
metadata:
  category: office
  agent: m365_assistant
  display-name: "Microsoft 365 Productivity"
---
...
| `m365_mail_send` | Envía correo | `subject`, `body`, `to_recipients`, `cc_recipients`, `bcc_recipients`, `content_type`, `importance` |
...
3. Tras confirmación: `m365_mail_send(subject=..., body=..., to_recipients=[...], cc_recipients=[...])`
   - Para poner a alguien en copia usa `cc_recipients`; en copia oculta, `bcc_recipients`.
