---
name: biw_data_extraction
description: >-
  Técnicas de extracción: InfoCubes, DSOs, queries BEx, navegación
  multidimensional.
metadata:
  category: data
  agent: sap_analyst
  display-name: "Extracción BIW"
---

# Patrones de extracción SAP BIW - KH Lloreda

## Uso de biw_executeQuery

La herramienta `biw_executeQuery` genera MDX internamente. Nunca necesitas escribir MDX. Parámetros:
...
## Uso de biw_getQueryMetadata

Usa `biw_getQueryMetadata` para descubrir medidas y dimensiones antes de ejecutar una query desconocida. Retorna:
